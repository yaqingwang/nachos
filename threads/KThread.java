...
public class KThread {
	...
	public static void finish() {
		...
		if(currentThread.waitForJoined != null){
		    currentThread.waitForJoined.ready();
		}
	...
	*/
	...
	// when call join, store currentThread, when finished, wake it up 
	private KThread waitForJoined = null; 
